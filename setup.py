...
setup(
	...
	description="tools for working with TSV and Util files",
	long_description="""\
	Several scripts for working with Util files and TSV files. Fixing symbol names, querying large TSV files, etc.
	""",
