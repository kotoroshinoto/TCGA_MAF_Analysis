...
@click.group(no_args_is_help=True, help="prepare and check status of COSMIC entries")
def cli():
	pass
...
@cli.command(help="build table from cosmic VCF and TSV files", name='prep')
...
@cli.command(help="check cosmic prediction for mutation effects", name="check")
